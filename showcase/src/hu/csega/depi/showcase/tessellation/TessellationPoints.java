...
public class TessellationPoints extends ShowcaseWindow {

	protected TessellationPoints() {
		super(TITLE);
	}
	...
	public static void main(String[] args) throws Exception {
		new TessellationPoints();
	}

	private static final double EPSILON = 0.00000001;
	private static final double FORCE_SCALAR = 100.0;
